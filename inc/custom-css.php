...
function wells_get_customizer_css( $type = 'front-end' ) {
  ...
  $nav_link_current_color        = get_theme_mod('nav_link_current_color', '#191970');
  ...
  $mobile_nav_link_current_color = get_theme_mod('mobile_nav_link_current_color', '#191970');
  ...
  $styles = '
    ...
    .main-navigation .current_page_item > a, .main-navigation .current-menu-item > a, .main-navigation .current_page_ancestor > a, .main-navigation .current-menu-ancestor > a { color: '. $nav_link_current_color .' }
    ...
    .mobile-navigation .current_page_item > a, .mobile-navigation .current-menu-item > a, .mobile-navigation .current_page_ancestor > a, .mobile-navigation .current-menu-ancestor > a { color: '. $mobile_nav_link_current_color .' }
